...
## Project Structure
    ...
    ├── testapiautoconnect_115009  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_115009`
...
2. Clone this repo and `cd testapiautoconnect_115009`
